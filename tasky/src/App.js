...
function App() {
  const [ taskState, setTaskState ] = useState({
    tasks: [
      ...
      { id: 4, title: "Wash car", description: "Clean Car", deadline: "Today", done: false, priority: "High" },
      { id: 5, title: "Go to College", description: "Attend College", deadline: "Morning", done: false, priority: "Low"}
    ]
  });
